...
$DOCKER run --rm --network host \
    ...
    /bin/bash -c '
        ...
        python3 ./sev-snp-measure/sev-snp-measure.py \
            ...
            --append="console=ttyS0 ip=dhcp quiet loglevel=0 random.trust_cpu=on random.trust_bootloader=off amd_iommu=force_isolation iommu.strict=1 iommu.passthrough=0 mitigations=auto,nosmt spectre_v2=on pti=on gather_data_sampling=force srso=safe-ret retbleed=auto,nosmt fips=1 lockdown=confidentiality" | tr -d "\n" > sev_measurement.txt
